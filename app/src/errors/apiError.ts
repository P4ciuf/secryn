...
export class ApiError extends Error {
  ...
  /**
   * Creates an ApiError with HTTP 400 status.
   *
   * @param message - Human-readable error description
  ...
  /**
   * Creates an ApiError with HTTP 401 status.
   *
  ...
  /**
   * Creates an ApiError with HTTP 403 status.
   *
   * @param message - Human-readable error description
  ...
  /**
   * Creates an ApiError with HTTP 404 status.
   *
   * @param message - Human-readable error description
  ...
  /**
   * Creates an ApiError with HTTP 409 status.
   *
   * @param message - Human-readable error description
   */
  ...
  /**
   * Creates an ApiError with HTTP 500 status.
   *
   * @param message - Human-readable error description
   */
  ...
  /**
   * Creates an ApiError with HTTP 406 status.
   *
   * @param message - Human-readable error description
   */
  ...
  /**
   * Creates an ApiError with HTTP 429 status and a default rate-limit message.
   */
  ...
  /**
   * Creates an ApiError with HTTP 404 status using a dynamic resource name.
   *
